...
import com.plcoding.spotifycloneyt.BottomNavigationMenu
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navBtn = findViewById<BottomNavigationView>(R.id.bottom_navigation)
        ...
        navHostFragment.findNavController().addOnDestinationChangedListener { _, destination, _ ->
            when(destination.id) {
                ...
                R.id.homePrincipalFragment -> showBottomBar()
                else -> showBottomBar()
            }
        }
        navBtn.setupWithNavController(navHostFragment.findNavController())
    }
